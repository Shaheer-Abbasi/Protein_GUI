...
class ToolCard(QFrame):
    ...
    def refresh(self):
        ...
        self.system_btn.setEnabled(status.source in {"system", "configured", "wsl"} or current_platform_key() == "windows")
...
class DatabaseDownloadsPage(QWidget):
    ...
    def _init_ui(self):
        ...
        self.tabs.addTab(self.tools_scroll, feather_icon("tool", 16), "Tools")
    ...
    def _load_tools(self):
        ...
        intro = QLabel(
            ...
            "alignment, and database conversion."
        )
    ...
    def _on_tool_install_finished(self, result: dict):
        ...
        tool_names = ", ".join(TOOLS[tool_id].display_name for tool_id in result.get("tool_ids", []))
        QMessageBox.information(
            self,
